...
class WorkbenchModerationSchemaTest extends KernelTestBase {
  ...
  public function testWorkbenchModerationNodeTypeConfig() {
    ...
    $node_type->setThirdPartySetting('workbench_moderation', 'display_moderation_information', TRUE);
  ...
  public function testWorkbenchModerationBlockContentTypeConfig() {
    ...
    $block_content_type->setThirdPartySetting('workbench_moderation', 'display_moderation_information', TRUE);
